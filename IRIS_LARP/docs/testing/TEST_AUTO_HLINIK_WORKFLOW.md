...
1. **Check test directories:**
   ...
   - `/IRIS_LARP/docs/testing/` - Test documentation and results
...
3. **Check feature list:**
   - Review `/IRIS_LARP/docs/technical/FEATURE_LIST.md` for complete feature inventory
...
Save all results to:
```
/IRIS_LARP/docs/testing/results/[YYYYMMDD]/
├── TEST_[ID]_report.md
├── screenshots/
│   ├── TEST_[ID]_01.png
│   ├── TEST_[ID]_02.png
